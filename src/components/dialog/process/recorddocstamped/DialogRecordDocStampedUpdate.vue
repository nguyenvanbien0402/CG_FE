...
const update = (request) => {
  RecordDocStampedRepository.update(request).then(function (response) {
...
const getDataUpdate = (request) => {
  RecordDocStampedRepository.getById(request).then(function (response) {
    data.request.receiptDate = response.data.deliveryDate
